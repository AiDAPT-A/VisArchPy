...
def save_pickle_dinov2(pickle_filename: str, outputs: BaseModelOutputWithPooling) -> None:
    """
    ...
    if not isinstance(outputs, BaseModelOutputWithPooling):
...
def load_pickle_dinov2(pickle_filename: str) -> BaseModelOutputWithPooling:
    ...
    -------
    outputs : BaseModelOutputWithPooling
        Outputs of dinov2 model according to the 'transformers' package data types. 
        A Python object
    """
...
def transform_to_dinov2(image_file: str, model_name: str):
    """
