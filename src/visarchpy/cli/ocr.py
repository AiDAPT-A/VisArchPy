...
def from_dir(
    directory: str = typer.Argument(help="Path to directory containing PDF\
    files"),
        output: str = typer.Argument(help="Path to output directory")) -> None:
